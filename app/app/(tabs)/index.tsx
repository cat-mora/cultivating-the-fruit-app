...
export default function DashboardScreen() {
  const { completeActivityToday, hasCompletedToday, getStreakInfo } =
    useStreak();
  ...
  const scriptureText =
    content?.bible_text[selectedTranslation] || content?.bible_text["NIV"];
  ...
  return (
    <View className="flex-1 bg-cream">
      ...
      >
        <View style={{ marginBottom: 8 }}>
          ...
          >
            ...
            >
              ...
              <Text className="text-2xl font-serif text-wine">
                {displayContent.fruit_theme}
              </Text>
            </View>
            <View
            ...
            >
              ...
              >
                <Text
                  style={{
                    color: canGoPrev ? "white" : "rgba(47,47,47,0.2)",
                    fontWeight: "bold",
                    fontSize: 16,
                  }}
                >
              ...
              >
                <Text
                  style={{
                    color: canGoNext ? "white" : "rgba(47,47,47,0.2)",
                    fontWeight: "bold",
                    fontSize: 16,
                  }}
                >
        ...
        {streak.currentStreak > 0 && (
          <View
            style={{
              ...
              backgroundColor: "rgba(184,142,48,0.15)",
        ...
        <View
          className="bg-rose-dark rounded-[20px] shadow-lg"
          style={{ padding: 16, marginBottom: 10 }}
        >
          <Text
            className="text-white/40 text-3xl font-serif"
          ...
          <Text
            ...
            style={{ lineHeight: 24, marginTop: 16, marginBottom: 6 }}
          >
            {displayContent.scriptureText}
          </Text>
          <Text className="text-white/70 text-center font-bold text-xs">
          ...
          {timeTiers.map((tier) => (
            <Pressable
              ...
              style={{
                ...
                borderRadius: 20,
                backgroundColor:
                  selectedIndex === tier.index ? "#6B3B5E" : "#EDE8E0",
              }}
            >
              <Text
                style={{
        ...
        {selectedActivity && (
          <View className="bg-blush rounded-[20px]" style={{ padding: 16 }}>
            <Text
              className="text-xl font-serif text-wine"
            ...
            >
              <Text
                style={{
                  color: isPreviewing ? "rgba(47,47,47,0.4)" : "white",
                  fontSize: 15,
                  fontWeight: "bold",
                }}
              >
