...
import { getAllUsers, type AdminUserData } from '../../../lib/admin/admin-service';
        ...
        <View style={styles.userDetails}>
          ...
          <View style={styles.detailRow}>
            ...
            <Text style={styles.detailValue}>
              {item.signup_code || 'N/A'}
            </Text>
          </View>
          <View style={styles.detailRow}>
            <Text style={styles.detailLabel}>Partner Links:</Text>
            <Text style={[styles.detailValue, item.has_partner_link && styles.activeStatus]}>
